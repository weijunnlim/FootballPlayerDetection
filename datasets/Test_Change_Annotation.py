...
with open('/home/weijunl/3_test_1min_hamkam_from_start/gt/labels.txt', 'r') as f:
    labels = f.read().splitlines()

# Directory where your images and annotations will be stored
images_dir = '/home/weijunl/Football-Object-Detection/datasets/dataset/test/images'
gt_file = '/home/weijunl/3_test_1min_hamkam_from_start/gt/gt.txt'
