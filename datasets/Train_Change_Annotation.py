...
with open('/home/weijunl/1_train-val_1min_aalesund_from_start/gt/labels.txt', 'r') as f:
    labels = f.read().splitlines()

# Directory where your images and annotations will be stored
images_dir = '/home/weijunl/Football-Object-Detection/datasets/dataset/train/images'
gt_file = '/home/weijunl/1_train-val_1min_aalesund_from_start/gt/gt.txt'
